...
- (void) createPost_VISH {
    ...
    // Dictionary that holds then basic authentication data.
    NSDictionary* basicAuth = @{
    @"email": @"PONER_USER@dit.upm.es",
    ...
    NSString* FileParamConstant = @"document[file]";
    ...
    // set Basic authentication in HTTP header
    NSString *user_password = [NSString stringWithFormat:@"%@:%@", basicAuth[@"email"], basicAuth[@"password"]];
